...
public class CreateStreamsTest {
   ...
   public void p1_readOrderFromFile() throws IOException {
       Path path = Paths.get("D:\\Learnings\\Java\\FP-By-VictorRentea\\Essentials\\workshop\\test.ok.txt");

      List<OrderLine> orderLines = service.p1_readOrderFromFile(path);
   ...
   public void p1_readOrderFromFile_throws() throws IOException {
       Path path = Paths.get("D:\\Learnings\\Java\\FP-By-VictorRentea\\Essentials\\workshop\\test.invalid.txt");
      service.p1_readOrderFromFile(path); // look at stacktrace
